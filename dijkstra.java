 ...
 * graph with 200 vertices labeled 1 to 200. Each row consists of the node tuples that are adjacent 
 * to that particular vertex along with the length of that edge. For example, the 6th row has 6 as 
 * the first entry indicating that this row corresponds to the vertex labeled 6. The next entry of 
 ...
 *
 * Your task is to run Dijkstra's shortest-path algorithm on this graph, using 1 (the first 
 ...
 * 
 * output: shortest path of nodes: 7,37,59,82,99,115,133,165,188,197
 */
